...
public class XMLValidator_1 {
    public static final String XML_FILE = "Pawning.xml";
    public static final String SCHEMA_FILE = "goAMLSchema-Version_2.0.xsd";

    public static void main(String[] args) {
        XMLValidator_1 XMLValidator = new XMLValidator_1();
